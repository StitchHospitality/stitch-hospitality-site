      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto bg-[#071f1b] rounded-3xl p-10 lg:p-14">
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-full bg-[#ff6464]/20 border border-[#ff6464]/30 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-white/40 text-sm font-light">{testimonial.property}</p>
            </div>
          </div>
        </div>
      </div>
